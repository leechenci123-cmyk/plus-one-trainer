...
| 2 | 测试工坊 / Test workshop | 0–32 全僵尸目录保留；Beta 3 禁用生成、扶梯与清理按钮 / all zombie IDs remain cataloged; spawn, ladder, and cleanup buttons are disabled in Beta 3 |
...
- Night Roof Endless is explicitly labeled an experiment, not an original hidden mode. Beta 3 keeps its button disabled pending live verification of internal calls.
